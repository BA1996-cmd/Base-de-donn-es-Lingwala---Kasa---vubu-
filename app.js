        var metaCouches = JSON.parse('{"Communes": {"fichier": "data/Communes.geojson", "geom_type": 2, "popup_fields": ["fid", "id", "id_commune", "id_voirie", "Nom", "Sup/Km²", "Géométri", "Centoîde", "Population", "Type"], "legend_style": [], "is_polygon": true, "is_line": false, "is_point": false, "etiquette": null, "attr_classif": null}, "Intersection": {"fichier": "data/Intersection.geojson", "geom_type": 0, "popup_fields": ["fid_1", "Noeud", "Nom", "Geometrie", "Type", "Infrastruc", "Signalisat", "etat", "Carrefour"], "legend_style": [{"valeur": "default", "label": "Intersection", "img_path": "styles_images/icon_Intersection_unique.png"}], "is_polygon": false, "is_line": false, "is_point": true, "etiquette": {"champ": "Noeud", "couleur": "#323232", "taille": 14.0}, "attr_classif": null}, "Secteur d\'intervention joint": {"fichier": "data/Secteur_d\'intervention_joint.geojson", "geom_type": 1, "popup_fields": ["fid_1", "id", "Type", "Nom", "JField1", "JField2", "JField5", "JField7", "JField8", "JField9", "JField10", "JField11", "JField12", "JField13", "JField14", "JField15"], "legend_style": [{"valeur": "default", "label": "Secteur d\'intervention joint", "img_path": "styles_images/icon_Secteur_d\'intervention_joint_unique.png"}], "is_polygon": false, "is_line": true, "is_point": false, "etiquette": null, "attr_classif": null}, "Voiries": {"fichier": "data/Voiries.geojson", "geom_type": 1, "popup_fields": ["fid_1", "id", "Type", "Longueur", "Largeur", "Fissures", "Obstacles", "Variétés", "Etatvoirie", "CNV", "Etat CNV", "Inondation", "Prat", "Conflit", "Trott", "Etat trott", "Fréq", "Usagers", "Signal", "Ecl pub", "Arret TC", "Nom", "Revetement", "Sens de ci", "Commune", "Réhabilit", "Géométri", "nids de po", "Nb_noeuds", "Long_avenu", "Nids_fiss"], "legend_style": [{"valeur": "default", "label": "Voiries", "img_path": "styles_images/icon_Voiries_unique.png"}], "is_polygon": false, "is_line": true, "is_point": false, "etiquette": {"champ": "Nom", "couleur": "#323232", "taille": 14.0}, "attr_classif": null}}');
